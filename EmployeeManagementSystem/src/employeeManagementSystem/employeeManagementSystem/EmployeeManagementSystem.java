...
public class EmployeeManagementSystem {
    ...
    public static void main(String[] args) {
        handler.createNewEmployee(EmployeeCategory.PROGRAMMER, 1, "Oscar", "Bergström", 33333, Gender.MALE, "91/06/05", Department.IT);
        ...
        System.out.println(EmployeeHandler.getAllEmployees().size());
